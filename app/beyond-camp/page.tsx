...
import BeyondCamp from './BeyondCamp'

export const metadata: Metadata = {
  title: 'Beyond Camp | Practical Tech Skills for Students, NYSC Members, Graduates and Professionals',
  description:
    'Live, project-based training in web development, AI automation, data analysis, UI/UX design and mobile development. Online, Offline or Hybrid. See the prices that apply to you and register today.',
}
